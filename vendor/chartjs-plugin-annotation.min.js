...
!(function (t, e) {
  ...
  function u(
    ...
    { rect: o, center: n },
    i,
    { rotation: s, borderWidth: a, hitTolerance: d }
  ) {
    return h(r(t, n, e.toRadians(-s)), o, i, {
      borderWidth: a,
      hitTolerance: d,
    });
  }
        ...
        j.set(
          ...
          (function (t, e, o, n) {
            ...
            for (let a = 0; a < i; a++) {
              ...
              t.font = i.string;
              const d = e[a];
              (r = Math.max(r, t.measureText(d).width + n)),
                (s += i.lineHeight);
            }
  ...
  function N(t, o) {
        ...
        (function (t, o) {
          ...
          return (function (t, o) {
            ...
            for (let t = 0; t < 4; t++) {
              ...
              M.push({
                position: H[t],
                distance: e.distanceBetweenPoints(o, { x: c, y: h }),
              });
            }
    ...
    (a.margin > 0 || 0 === s.borderWidth) &&
      (t.moveTo(l.x, l.y), t.lineTo(c.x, c.y)),
      t.moveTo(h.x, h.y),
      t.lineTo(u.x, u.y);
  ...
  function $(t, e) {
    if (t) {
      ...
      return {
        start: V(t, e.min, o ? e.end : e.start),
        end: V(t, e.max, o ? e.start : e.end),
      };
    }
  }
  function U(t, e) {
      ...
      switch (e.type) {
        ...
        case "mouseout":
          return (function (t, e, o) {
            ...
            i =
              "mousemove" === e.type
                ? n(t.visibleElements, e, o.interaction)
                : [];
            const r = t.hovered;
            t.hovered = i;
  ...
  function it({ state: t, event: e }, o, n, i) {
    let r;
    for (const s of n)
      i.indexOf(s) < 0 && (r = rt(s.options[o] || t.listeners[o], s, e) || r);
    return r;
  }
  function rt(t, o, n) {
        ...
        const { left: i, top: r, right: s, bottom: a } = t,
          ...
          g = (function (t, o, n, i) {
            ...
            const c = (-a - Math.sqrt(l)) / 2,
              h = (-a + Math.sqrt(l)) / 2;
            return {
              _startAngle: e.getAngleFromPoint({ x: o, y: n }, { x: c, y: t })
                .angle,
              _endAngle: e.getAngleFromPoint({ x: o, y: n }, { x: h, y: t })
                .angle,
            };
          })(b ? r + y : a - y, h, u, p),
          m = {
  ...
  const pt = (t, e, o) => ({
    ...
    St = (t, o, n, i) =>
      -Math.atan2(Pt(t.x, o.x, n.x, i), Pt(t.y, o.y, n.y, i)) + 0.5 * e.PI;
  ...
  function Yt(t, { x: e, y: o }, { angle: n, adjust: i }, r) {
    r &&
      r.display &&
      (t.save(), t.translate(e, o), t.rotate(n), It(t, 0, -i, r), t.restore());
  }
  (Ct.defaults = {
    adjustScaleRange: !0,
    arrowHeads: {
    ...
    inRange(t, o, n, i) {
      ...
      if ("x" !== n && "y" !== n)
        return (function (t, o, n, i) {
          ...
          { x: t, y: o },
          this.getProps(["width", "height", "centerX", "centerY"], i),
          s,
          d
        );
      const {
  ...
  class Et extends t.Element {
    ...
    draw(t) {
      ...
      let i = !0;
      for (const o of e)
        i ? (t.moveTo(o.x, o.y), (i = !1)) : t.lineTo(o.x, o.y);
      t.closePath(),
        t.fill(),
  ...
  function Wt(
    { centerX: t, centerY: e },
    { radius: o, borderWidth: n, hitTolerance: i },
    r
  ) {
    const s = (n + i) / 2,
      a = Math.sin(r),
  ...
  Object.keys(zt).forEach((e) => {
    t.defaults.describe(`elements.${zt[e].id}`, {
  ...
  function Jt(t, e, o, n) {
    ...
    let r = t[e];
    return (
      (r && r instanceof i) || ((r = t[e] = new i()), Object.assign(r, n)), r
    );
  }
  function qt(t) {
  ...
  var ee = {
    ...
    descriptors: {
      ...
      annotations: {
        _allKeys: !1,
        _fallback: (t, e) => `elements.${zt[Vt(e.type)].id}`,
      },
  ...
  function ne(t, e, o, n) {
    const i = n.element;
    n.main
      ? (at(o, i, "beforeDraw"), i.draw(t, e), at(o, i, "afterDraw"))
      : i.draw(t, e);
  }
